        ...
        advices: [
            {
                ...
                description: "Idéale pour les combles difficiles d’accès ou non aménageables. Nous projetons un isolant en flocons (laine de verre, laine de roche, ouate de cellulose...) sur toute la surface, garantissant une couverture homogène et sans pont thermique."
            },
            {
                title: "Isolation en rouleaux <br> (laine déroulée)",
                description: "Adaptée aux combles accessibles. Pose d’isolant en deux couches croisées pour une excellente performance thermique (R élevé) et une meilleure durabilité."
            },
            {
